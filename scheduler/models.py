...
class EnrolledSubject(models.Model):
    ...
    child = models.ForeignKey(Child, on_delete=models.CASCADE, related_name='enrolled_subjects')
    subject_name = models.CharField(max_length=100)
...
class ScheduledLesson(models.Model):
    ...
    child = models.ForeignKey(Child, on_delete=models.CASCADE, related_name='scheduled_lessons')
