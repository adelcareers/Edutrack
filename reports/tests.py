...
from courses.models import Course, GlobalAssignmentType, sync_course_assignment_types_from_global
...
class GradebookViewsAndServiceTests(TestCase):
    ...
    def test_gradebook_detail_post_updates_assignment_grade(self):
        response = self.client.post(
            reverse('reports:gradebook_detail', kwargs={'enrollment_id': self.enrollment.id}),
            {
