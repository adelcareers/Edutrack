...
current_story: S2.9
current_story_title: Parent Read-Only Calendar
...
stories_done: [S0.1, S0.2, S0.3, S0.4, S0.5, S0.6, S0.7, S1.1, S1.2, S1.3, S1.4, S1.5, S1.6, S1.7, S1.8, S1.9, S1.10, S2.1, S2.2, S2.3, S2.4, S2.5, S2.6, S2.7, S2.8]
stories_in_progress: []
stories_blocked: []
last_commit: '7e5e283'
heroku_url: 'https://edutrack-3e8b5606319f.herokuapp.com'
